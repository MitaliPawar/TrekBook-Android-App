...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imgShowHidePwd=findViewById(R.id.show_hide_pwd);
        imgShowHidePwd.setImageResource(R.drawable.ic_baseline_visibility_off_24);
        imgShowHidePwd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(editTextLoginPwd.getTransformationMethod().equals(HideReturnsTransformationMethod.getInstance())){
                    ...
                    imgShowHidePwd.setImageResource(R.drawable.ic_baseline_remove_red_eye_24);
                }
            }
        });
        //open login Activity
