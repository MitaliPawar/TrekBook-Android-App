...
public class UpdateP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonUpdateEmail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(UpdateP.this,UpdateEmail.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(id==R.id.menu_refresh){
            ...
            Toast.makeText(UpdateP.this, "menu_settings", Toast.LENGTH_SHORT).show();
        }/*else if(id==R.id.menu_DeleteProfile){
            Intent  intent=new Intent(UpdateP.this,DeleteProfile.class);
            startActivity(intent);
